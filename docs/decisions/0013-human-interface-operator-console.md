...
H1 + H2 are done — there is now a live browser console (`streamlit run operator_console.py`) to watch and halt real runs. **H2b (chat dock) is next**, then H3 (approvals queue) and H4 (setup form + rationale).
